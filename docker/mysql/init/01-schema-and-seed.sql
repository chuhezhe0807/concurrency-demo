...
CREATE TABLE t_order_outbox (
  ...
  status      TINYINT      NOT NULL DEFAULT 0 COMMENT '0=NEW 待发送, 1=SENT 已确认投递, 2=SENDING 已投出待 confirm',
  retry_count INT          NOT NULL DEFAULT 0,
  last_send_time DATETIME  NULL COMMENT '最近一次投递时刻；SENDING 行据此判断是否在途，confirm 未回则超时后重发',
  create_time DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP,
